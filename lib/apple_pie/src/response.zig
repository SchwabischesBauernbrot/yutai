...
pub const Response = struct {
    ...
    buffered_writer: std.io.BufferedWriter(4096, Stream.Writer),
    ...
    pub const Error = Stream.WriteError || error{OutOfMemory};
    ...
    pub fn writeHeader(self: *Response, status_code: StatusCode) Error!void {
        ...
        if (!self.is_flushed) try self.flush();
    }
    ...
    pub fn empty(self: *const @This()) bool {
        return self.body.context.items.len == 0;
    }
};
